import 'package:vindoapp/helper/dbhelper.dart';
import 'package:vindoapp/models/user.dart';
...
class _SettingsPageState extends State<SettingsPage> {
  ...
  String developerName = "MELVINDO EDWIN ";
  String developer = "KENERO YUDHA ATAMBUA";
  String developerNim = "2141764182";
              ...
              children: [
                const CircleAvatar(
                  backgroundImage: AssetImage(
                      'assets/images/foto_vindo.jpg'), // Gantilah dengan path gambar Anda
                  radius: 50,
                ),
                Container(
