...
import 'package:vindoapp/models/finance.dart';
import 'package:vindoapp/constant/finance_type_constants.dart';
...
class DbHelper {
  ...
  void _createDb(Database db, int version) async {
    ...
    await db.insert("user", {'email': 'vindo@gmail.com', 'password': 'vindo'});
  }
